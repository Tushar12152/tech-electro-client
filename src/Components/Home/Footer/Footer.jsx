...
const Footer = () => {
    return (
        <footer className=" flex lg:flex-row  flex-col gap-6 mt-16  justify-around items-center p-4 text-neutral-content  bg-gradient-to-r from-green-500 to-cyan-500 ">
